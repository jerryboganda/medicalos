...
| ENG-01 | Daily goal, streak with freezes, question of the day; all disableable | implemented (server-authoritative daily progress/streak/freezes + per-exam QOTD + independent preferences + Today UI; local formatting/diff gates pass; heavy API/browser acceptance pending CI; product-analytics emission remains OPS-05 rather than being fabricated here) | `.scratch/phase-1-eng01-engagement/` |
